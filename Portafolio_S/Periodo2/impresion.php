...
<form action="procesar_impresion.php" method="post">
    <label for="numeroTareas">Número de Tareas:</label>
    <input type="number" name="numeroTareas" id="numeroTareas" min="1" required>
    <br><br>
