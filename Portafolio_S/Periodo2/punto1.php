...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($num > 0) {
        echo "<script>alert('el numero $num es positivo.')</script>";
    }elseif ($num < 0) {
        echo "<script>alert('el numero $num es negativo.')</script>";
    }else{
        echo "<script>alert('el numero es cero.')</script>";
    }
}
